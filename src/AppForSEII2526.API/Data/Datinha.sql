...
INSERT INTO [dbo].[AspNetUsers] ([Id], [Surname], [Name], [UserName], [NormalizedUserName], [Email], [NormalizedEmail], [EmailConfirmed], [PasswordHash], [SecurityStamp], [ConcurrencyStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEnd], [LockoutEnabled], [AccessFailedCount]) 
VALUES (N'user-002', N'Lopes', N'Patrik', N'patrik.lopes@email.com', N'PATRIK.LOPES@EMAIL.COM', N'patrik.lopes@email.com', N'PATRIK.LOPES@EMAIL.COM', 1, N'AQAAAAIAAYagAAAAEGJlFzgvI3GjBm0sYvMaQwzYb8aU5k59/G2J4K5XVkxPmxbKVt7sM01O6+mktdy8Fg==', N'415AEF77-B318-43BC-96D4-57347ED71A0D', N'8D6F3E42-20F5-4EF6-ACCC-F368DB0B16EB', N'+34600222333', 1, 0, NULL, 1, 0)
